...
void display(void)
{
    ...
    gluSphere(quadSol, (GLfloat)radius(rads[0]), 100, 80);
    ...
    gluSphere(quadMerc, (GLfloat)radius(rads[1]), 100, 80);
    ...
    glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, reflexo);
    gluSphere(quadVen, (GLfloat)radius(rads[2]), 100, 80);
    ...
    gluSphere(quadTerra, (GLfloat)radius(rads[3]), 100, 80);
    ...
    glRotatef((GLfloat)day[2], 0.0, 1.0, 0.0);
    glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, reflexo); // Reflexo de luminosidade
    gluSphere(quadLua, (GLfloat)radius(rads[3]) / 3.0, 100, 80);
    ...
    glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, reflexo);
    gluSphere(quadMarte, (GLfloat)radius(rads[4]), 100, 80);
    ...
    glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, reflexo);
    gluSphere(quadJup, (GLfloat)radius(rads[5]), 100, 80);
    ...
    glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, reflexo);
    gluSphere(quadSat, (GLfloat)radius(rads[6]), 100, 80);
...
float distance(float dist)
{
    ...
    return mapFloat(dist, 57, 4504, 1.3, 16);
}
